...
int main(int argc, char *argv[])
{
    ...
    TRint* app = LaunchRint("calibration test", argc, argv, 4);
    ...
    ant::analysis::DataOverview dataoverview("DataOverview");
    analysis.AddPhysics(&dataoverview);


    ant::analysis::TAPSCalibrationTest tapscal("TAPSCalibrationTest");
    analysis.AddPhysics(&tapscal);
